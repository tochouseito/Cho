...
void PlayerHit::Initialize()
{
	...
	effect->effectNodes[0].scale.pva.value.first = Vector3(0.8f, 0.8f, 0.8f);
	...
	effect->effectNodes[0].draw.meshModel.meshIndex = 14;
	effect->effectNodes[0].draw.meshSprite.color = Color(0.8f, 0.1f, 0.8f, 1.0f);
